...
public class IndexController {
    ...
    // 메인화면
    @GetMapping("/")
    public String index(Model model, @LoginUser SessionUser sessionUser){ // @LoginUser 만 사용하면 세션 정보 가져올 수 있다
